...
// If we want to use Postgres in the future, we only have to change the path!
...
mongodb.MongoClient.connect(`mongodb://${mongoAddr}/demo`)
    .then(db => {
        ...
        // If there are 4 parameters, Node assumes it's an error handler.
        // Will skip any handlers in between
    ...
    .catch(err => {
        // Goes to the terminal that is running the node.js script
       console.error(err);
    });